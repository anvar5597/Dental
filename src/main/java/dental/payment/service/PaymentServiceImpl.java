/**
 * Author: Anvar Olimov User:user Date:7/10/2024 Time:12:13 PM
 */
...
public class PaymentServiceImpl implements PaymentService {
  ...
  public String create(PaymentRequestDto dto) {
    ...
    Integer paid = patientHistory.getPaid() + dto.getPaidValue() + dto.getSaleValue();
    patientHistory.setSale(Integer.sum(patientHistory.getSale(),dto.getSaleValue()));
    ...
    return paid + " so`m to`landi.  " + dto.getSaleValue() + " so`m chegirma"
  ...
  public PaymentResponseDto toDto(PaymentEntity entity) {
    ...
    responseDto.setDebit(
        entity.getPatientHistoryEntity().getTotal() - entity.getPatientHistoryEntity().getPaid());
    responseDto.setSale(entity.getPatientHistoryEntity().getSale());
